...
import Icon from 'react-native-vector-icons/MaterialIcons'; // Calendar icon from Material Icons
...
const DatePickerInput = () => {
  ...
  const onChange = (event, selectedDate) => {
    ...
    setShow(false);
    setDate(currentDate);
    setDateString(currentDate.toLocaleDateString()); // Format the date to string
  };
